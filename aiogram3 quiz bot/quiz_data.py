quiz_data = [
    ...
    },
    {
        ...
        'options': ['China', 'Italy', 'USA', 'France'],
        'correct_option': 0
    },
    {
        'question': 'Which animal sleeps the most?',
        'options': ['Cats', 'My brother', 'Sloths', 'Koalas'],
        'correct_option': 3
    },
    {
    ...
    {'question': 'What did the ancient Romans use as a mouthwash?',
     'options': ['Urine', 'Saltwater', 'Wine', 'Vinegar'],
     'correct_option': 0
    },
    ...
    {'question': 'In what country were the first potatoes fried and served as French fries?',
     'options': ['USA', 'France', 'Belgium', 'Germany'],
     'correct_option': 2
    },
    ...
    {'question': 'What color are aircraft black boxes?',
     'options': ['Orange', 'Black', 'Red', 'Blue'],
     'correct_option': 0
    },
    {'question': 'What planet does Elon Musk plan to explore',
     'options': ['Neptune', 'Mercury', 'Uranus', 'Pluto'],
     'correct_option': 2
    },
    {'question': 'Which country produces the most chocolate?',
     'options': ['Switzerland', 'Belgium', 'Nigeria', 'Ivory Coast'],
     'correct_option': 3
    },
]
